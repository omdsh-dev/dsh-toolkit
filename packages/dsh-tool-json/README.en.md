...
- **Consumption verification**: tarball installed into the 0.1.5-rc.1 consumer → `dsh --profile compat --dump-config` shows this plugin's row → the tool actually registers and executes
