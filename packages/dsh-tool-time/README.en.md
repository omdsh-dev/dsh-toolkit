...
- **Adapted DSH**: DSH 0.1.2-alpha.3 (profile/bundle plugin system)
...
> Note: the patch is id-targeted (DSH 0.1.2-alpha.3) — a bare `- id:` entry reports `entry "xxx" not found`; you must wrap it in a `- insert:` list.
