...
The repository lives at [omdsh-dev/dsh-tool-schema](https://github.com/omdsh-dev/dsh-tool-schema) (public). Install this plugin as a standalone bundle into a profile (DSH 0.1.2-alpha.2):
